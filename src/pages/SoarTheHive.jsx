  ...
  return (
    <div className="soar-page">
      <style>{`
        ...
        /* NAV */
        .soar-nav { padding:1.5rem 0; border-bottom:1px solid rgba(255,255,255,0.07); position:sticky; top:0; background:rgba(11,13,20,0.95); backdrop-filter:blur(12px); z-index:100; }
